...
<div class="container">
 <h3>Berita Bazar</h3>
  <p>Sistem Pengelolaan Berita Lingkungan Kerja BKN Pusat</p>
   ...
   <?php endif; ?>
   <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo"><span class="glyphicon glyphicon-pencil"></span> Edit Berita Bazar</button>
   <?php echo anchor(site_url('bazar'), 'Back', 'class="btn btn-warning"'); ?>
  <div id="demo" class="collapse">
    <div class="panel panel-default">
    <div class="panel-heading">Input Berita Bazar</div>
    <div class="panel-body">
      <?php foreach ($bazarr as $ku) { ?>
      <form action="<?php echo base_url().'index.php/bazar/update'; ?>" method="post">
    <div class="form-group">
      <label for="">Nama Pengumuman</label>
      <input type="hidden" name="id" value="<?php echo $ku->id ?>">
      <input type="text" class="form-control" name="nama_pengumuman"  value="Kegiatan Bazar">
    </div>
    <div class="form-group">
      <label for="">Nama Kegiatan</label>
      <input type="text" class="form-control" name="nama_kegiatan" required="data hasrus diisi" value="<?php echo $ku->nama_kegiatan?>">
     </div>
      <div class="bootstrap-iso">
            ...
            <form method="post">
              <label class="control-label " for="date">Tanggal Mulai</label>
               <div class="input-group">          
                <input class="form-control" name="date" required="data harus diisi" value="<?php echo $ku->date ?>" type="text" >
            ...
            <div class="col-md-12">
              <form method="post"> 
                <label class="control-label" for="datee">Tanggal Selesai</label>
                  <div class="input-group">          
                   <input class="form-control" name="datee" required="data harus diisi" value="<?php echo $ku->datee ?>" type="text">
                    <span class="input-group-addon">
                   <span class="glyphicon glyphicon-calendar"></span>
                  </span>
                </div>     
        ...
        <label class="input-group clockpicker" for="clockpicker">Jam Mulai</label>
          <div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true">  
           <input type="text" class="form-control" name="jam_mulai" value="<?php echo $ku->jam_mulai ?>">
            <span class="input-group-addon">
        ...
        <label class="control-label " for="date">Jam Selesai</label>
          <div class="input-group clockpicker" data-placement="left" data-align="top" data-autoclose="true">
           <input type="text" class="form-control" name="jam_selesai" value="<?php echo $ku->jam_selesai ?>">
            <span class="input-group-addon">
           <span class="glyphicon glyphicon-time"></span>
          </span>
        </div>
        <br>
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="tempat_kegiatan" required="data hasrus diisi" value="<?php echo $ku->tempat_kegiatan ?>">
          </div>
