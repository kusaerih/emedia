...
<div class="container">
 <h3>Berita Kegiatan</h3>
  <p>Sistem Pengelolaan Berita Lingkungan Kerja BKN Pusat</p>
   ...
   <?php endif; ?>
   <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo"><span class="glyphicon glyphicon-plus"></span> Tambah Berita Dress Code</button><br>
    ...
    <div class="form-group">
      ...
      <div class="bootstrap-iso">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="dress_code" required="data hasrus diisi" placeholder="Dress Code">
        </div>
...
<tbody>
<?php $no = 1; foreach ($dress_codee as $ok) { ?>
  <tr>
    <td><?php echo $no++ ?></td>
    <td><?php echo $ok->nama_pengumuman; ?></td>
    <td><?php echo $ok->nama_kegiatan; ?></td>
    <td><?php echo $ok->date; ?></td>
    <td><?php echo $ok->jam_mulai; ?></td>
    <td><?php echo $ok->jam_selesai; ?></td>
    <td><?php echo $ok->tempat_kegiatan?></td>
    <td><?php echo $ok->dress_code; ?></td>
    <td><center><?php echo anchor('dress_code/edit/'.$ok->id, '<button type="button" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></button>'); ?>
                <?php echo anchor('dress_code/hapus/'.$ok->id, '<button onclick="return confirm(\'Apakah Anda Yakin Ingin menghapus Data ini ???\')" type="button" class="btn btn-danger"><span class=" glyphicon glyphicon-trash"></span></button>'); ?></center></td>
